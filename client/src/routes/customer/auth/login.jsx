...
function Login() {
  ...
  return (
    <>
      <Nav />
      <div className='container flex flex-col justify-center items-center h-full mt-[-3em]'>
        <h2 className='text-2xl font-bold text-center my-4'>Customer Login</h2>
        ...
        <div className='mt-10 text-center'>
          ...
          <Link to='/register' className='text-[#0a4203] hover:underline'>
            Register here
          </Link>
        </div>
